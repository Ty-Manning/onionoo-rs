...
pub mod all {
    ...
    pub const SELECTION_PARAMS: &[&str] = &[
        "type", "running", "search", "lookup", "country", "as", "as_name", "flag",
        "first_seen_days", "last_seen_days", "first_seen_since", "last_seen_since",
        "contact", "family", "version", "os", "host_name", "recommended_version",
    ];
